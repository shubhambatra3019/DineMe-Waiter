...
class AddNewTableViewController: UIViewController {
    ...
    let people = ["Chicken", "Specials", "Lamb", "Lamb", "Lamb", "Lamb"]
    
    //let menuItems = [MenuItem(itemName: "Chicken1", itemDescription: "sample", itemPrice: 20.00), MenuItem(itemName: "Chicken1", itemDescription: "sample", itemPrice: 20.00), MenuItem(itemName: "Chicken1", itemDescription: "sample", itemPrice: 20.00), MenuItem(itemName: "Chicken1", itemDescription: "sample", itemPrice: 20.00), MenuItem(itemName: "Chicken1", itemDescription: "sample", itemPrice: 20.00), MenuItem(itemName: "Chicken1", itemDescription: "sample", itemPrice: 20.00)]
    
    //let data = ["Chicken": ["Chicken1","Chicken1","Chicken1","Chicken1","Chicken1","Chicken1"], "Lamb": ["Lamb1","Lamb1","Lamb1","Lamb1","Lamb1","Lamb1"], "Specials": ["Lamb1","Lamb1","Lamb1","Lamb1","Lamb1","Lamb1"],"Dessert": ["Chicken1","Chicken1","Chicken1","Chicken1","Chicken1","Chicken1"]]
...
extension AddNewTableViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let ix = IndexPath(row: 1, section: indexPath.row)
...
extension AddNewTableViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let cell = tableView.cellForRow(at: indexPath) as! MenuItemsTableViewCell
