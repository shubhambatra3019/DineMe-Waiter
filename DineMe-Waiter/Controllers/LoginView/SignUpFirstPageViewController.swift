...
class SignUpFirstPageViewController: UIViewController {
    ...
    lazy var signupLabel : UILabel = {
        let label = UILabel()
        label.text = "To sign up, please type in your email address."
    ...
    lazy var emailTextField = UITextField.getTextField("Email")
    ...
    @objc func handleContinue(){
        guard let email = emailTextField.text, email != "" else {
            errorLabel.text =  "Please type in your email"
            return
        }
...
//        }
        ...
        let signUpVC = SignUpSecondPageViewController()
