...
class SignUpView : UIView{
    ...
    let reEnterPasswordTextField : UITextField = {
        let txtField = UITextField.getTextField("Re-Enter Password")
        txtField.isSecureTextEntry = true
        return txtField
    }()
    
    let firstNameTextField : UITextField = {
        let txtField = UITextField.getTextField("First Name")
        txtField.autocapitalizationType = .sentences
        return txtField
    }()
    
    let lastNameTextField : UITextField = {
        let txtField = UITextField.getTextField("Last Name")
        txtField.autocapitalizationType = .sentences
        return txtField
    }()
    ...
    let agreeWithTermsLabel : UILabel = {
        let label = UILabel()
        label.text = "By creating an account, you agree to our "
